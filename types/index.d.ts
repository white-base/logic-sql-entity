...
// export { MetaRowConstructor }                     from 'logic-entity';
// export { BaseColumnCollectionConstructor }        from 'logic-entity';
// export { MetaRowCollectionConstructor }           from 'logic-entity';
// export { MetaTableColumnCollectionConstructor }   from 'logic-entity';
// export { MetaTableCollectionConstructor }         from 'logic-entity';
// export { MetaViewColumnCollectionConstructor }    from 'logic-entity';
// export { MetaViewCollectionConstructor }          from 'logic-entity';
// export { TransactionCollectionConstructor }       from 'logic-entity';

// // local modules
// export { SQLTable }                     from './sql-table.js';
// export { SQLColumn }                    from './sql-column.js';
// export { SQLRow }                       from './sql-row.js';
// export { SQLRowCollection }             from './collection-sql-row.js';